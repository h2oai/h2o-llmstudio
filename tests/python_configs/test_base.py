from llm_studio.python_configs.text_causal_language_modeling_config import ConfigProblemBase as CausalConfigProblemBase
from llm_studio.python_configs.text_rlhf_language_modeling_config import ConfigProblemBase as RLHFConfigProblemBase
...
def test_from_dict():
    for cfg_class in [RLHFConfigProblemBase, CausalConfigProblemBase, Seq2SeqConfigProblemBase]:
        cfg = cfg_class()
        cfg_dict = convert_cfg_base_to_nested_dictionary(cfg)
        cfg2 = cfg_class.from_dict(cfg_dict)
