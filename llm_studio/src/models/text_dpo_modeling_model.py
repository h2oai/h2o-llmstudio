...
from llm_studio.src.losses.text_causal_language_modeling_losses import TokenAveragedCrossEntropyLoss
...
class Model(nn.Module):
    ...
    def forward(
        ...
        if self.training:
            ...
            outputs["loss"] = TokenAveragedCrossEntropyLoss(self.cfg)(chosen_logits, chosen_labels)
